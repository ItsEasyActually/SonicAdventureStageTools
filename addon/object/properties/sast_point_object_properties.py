...
from ...settings.properties.sast_settings_properties import SASTSettingsProperties
...
class SASTPointObjectProperties(bpy.types.PropertyGroup):
    ...
    def draw_shader(obj: bpy.types.Object, is_selected: bool, shader: GPUShader):
        ...
        scene_props: SASTSettingsProperties = SASTSettingsProperties.get_settings()
        if (scene_props.disp_point_links):
            ...
            if (geonode.node != None):
                ...
                if (scene_props.disp_point_cam_links):
                    cam_points = []
                    cam_indices = []
                    cam_points.append((geonode.get_camera_x_point(), geonode.get_camera_z_point(), geonode.get_camera_y_point()))
                    if (props.link1 != None):
                        node1: SA2PointNode = SA2PointNode(props.link1)
                        if (node1.node != None):
                            cam_points.append((node1.get_camera_x_point(), node1.get_camera_z_point(), node1.get_camera_y_point()))
                            cam_indices.append((0,1))
                            if (props.link2 != None):
                                node2: SA2PointNode = SA2PointNode(props.link2)
                                if (node2.node != None):
                                    cam_points.append((node2.get_camera_x_point(), node2.get_camera_z_point(), node2.get_camera_y_point()))
                                    cam_indices.append((0,2))
                                    if (props.link3 != None):
                                        node3: SA2PointNode = SA2PointNode(props.link3)
                                        if (node3.node != None):
                                            cam_points.append((node3.get_camera_x_point(), node3.get_camera_z_point(), node3.get_camera_y_point()))
                                            cam_indices.append((0,3))
                                            if (props.link4 != None):
                                                node4: SA2PointNode = SA2PointNode(props.link4)
                                                if (node4.node != None):
                                                    cam_points.append((node4.get_camera_x_point(), node4.get_camera_z_point(), node4.get_camera_y_point()))
                                                    cam_indices.append((0,4))
                                                    if (props.link5 != None):
                                                        node5: SA2PointNode = SA2PointNode(props.link5)
                                                        if (node5.node != None):
                                                            cam_points.append((node5.get_camera_x_point(), node5.get_camera_z_point(), node5.get_camera_y_point()))
                                                            cam_indices.append((0,5))
                                                            if (props.link6 != None):
                                                                node6: SA2PointNode = SA2PointNode(props.link6)
                                                                if (node6.node != None):
                                                                    cam_points.append((node6.get_camera_x_point(), node6.get_camera_z_point(), node6.get_camera_y_point()))
                                                                    cam_indices.append((0,6))
                                
                    shader.uniform_float("lineWidth", 1.0)
                    shader.uniform_float("color",(1,0,1,1))
                    cam_batch =  batch_for_shader(shader, 'LINES', content={"pos": cam_points}, indices=cam_indices)
                    cam_batch.draw(shader)
        ...
        match (self.objtype):
            ...
            case 'CAM':
                match (scene_props.game_id):
                    case 'SADXPC':
                        if (self.objtype == 'CAM'):
                            GeometryNodeManager.create_node(obj, SA1CameraNode.modifier_file, SA1CameraNode.modifier_name)
                    case 'SA2BPC':
                        if (self.objtype == 'CAM'):
                            GeometryNodeManager.create_node(obj, SA2CameraNode.modifier_file, SA2CameraNode.modifier_name)
            case 'POINT':
                if (scene_props.game_id == 'SA2BPC'):
                    GeometryNodeManager.create_node(obj, SA2CameraNode.modifier_file, SA2PointNode.modifier_name)
            case 'NONE':
                GeometryNodeManager.clear_geometry_node(obj)
